...
export const HeroSection = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-32 pb-20">
      {/* Background Effects */}
      <div className="absolute inset-0 bg-hero-glow z-0" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/5 rounded-full blur-3xl animate-pulse-glow z-0" />
      ...
      {/* Floating Elements */}
      <div className="absolute top-1/4 left-[15%] w-2 h-2 bg-primary rounded-full animate-float z-0" />
      <div className="absolute top-1/3 right-[20%] w-3 h-3 bg-primary/60 rounded-full animate-float z-0" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-1/3 left-[25%] w-1.5 h-1.5 bg-primary/80 rounded-full animate-float z-0" style={{ animationDelay: '2s' }} />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground font-medium">Tecnologia, Marketing e Vendas</span>
          </motion.div>
